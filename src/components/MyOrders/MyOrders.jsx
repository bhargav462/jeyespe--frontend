    ...
    fetch(process.env.REACT_APP_API_URL + "/myOrders", {
      ...
      authentication(response, (orders) => {
        ...
        orders.forEach((order) => {
          ...
          order.items.forEach((orderUnits) =>
            displayList.push({
              ...orderUnits,
              _id: orderId,
              date: createdAt,
          ...
          return (
            <>
              <Paper key={order._id} className={classes.orderDetail}>
                ...
                <p>
                  <strong>Total</strong>: Rs. {order.price * order.quantity}
                </p>
                <p>
                ...
                <p>
                  ...
                  <StyledButton>Track Package</StyledButton>
                </Link>
                <p>{order.name}</p>
                <img
                  src={`${process.env.REACT_APP_API_URL}/images/${order.img}`}
                  width={"100px"}
                ></img>
              </Paper>
