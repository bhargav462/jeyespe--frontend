...
export default function TermsAndConditions(){
  ...
  return <Box className={classes.container} m={4} elevation={3}>
    ...
    <h1>License</h1>
      <p>redcarvings grants you a revocable, non-exclusive, non- transferable, limited license to download, install and use our service strictly in accordance with the terms of this Agreement.</p>
      <p>These Terms & Conditions are a contract between you and redcarvings (referred to in these Terms & Conditions as "redcarvings", "us", "we" or "our"), the provider of the redcarvings website and the services accessible from the redcarvings website (which are collectively referred to in these Terms & Conditions as the "redcarvings Service"). </p>
    ...
    <ul>
      ...
      <li><strong>Country:</strong>where redcarvings or the owners/founders of redcarvings are based, in this case is India.</li>
      <li><strong>Customer:</strong> refers to the company, organization or person that signs up to use the redcarvings Service to manage the relationships with your consumers or service users.</li>
      <li><strong>Device:</strong>any internet connected device such as a phone, tablet, computer or any other device that can be used to visit redcarvings and use the services.</li>
      ...
      <li><strong>Personnel:</strong> refers to those individuals who are employed by redcarvings or are under contract to perform a service on behalf of one of the parties.</li>
      ...
      <li><strong>Service:</strong>refers to the service provided by redcarvings as described in the relative terms (if available) and on this platform.</li>
      ...
      <li><strong>Website:</strong> <a>redcarvings</a>’s site, which can be accessed via this URL: <a>https://www.redcarvings.com/.</a></li>
      <li><strong>You:</strong> a  person or entity that is registered with redcarvings to use the Services.</li>
    </ul>
    <h1>Restrictions</h1>
    ...
    <p>Thanks for shopping with us. We appreciate the fact that you like to buy the stuff we build. We also want to make sure you have a rewarding experience while you’re exploring, evaluating, and purchasing our products.
    ...
    <h1>Waiver</h1>
    <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Agreement shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute waiver of any subsequent breach.
    ...
    <p>We may change our Service and policies, and we may need to make changes to these Terms so that they accurately reflect our Service and policies. Unless otherwise required by law, we will notify you (for example, through our Service) before we make changes to these Terms and give you an opportunity to review them before they go into effect. Then, if you continue to use the Service, you will be bound by the updated Terms. If you do not want to agree to these or any updated Terms, you can delete your account.
    </p>
